    ...
    public partial class Form1 : Form
    {
        ...
        {            
                ...
                if (_lineSpectrum.SpectrumProvider.GetFftData(fftBuffer, this))
                {
                    ...
                    int R, G, B;
                    R = Convert.ToInt32(Convert.ToDouble(Vis_Color.R));
                    G = Convert.ToInt32(Convert.ToDouble(Vis_Color.G));
                    B = Convert.ToInt32(Convert.ToDouble(Vis_Color.B));
            ...
            //{
                if (M_Profile_CB.Text != "")
                {
                    if (InitializeDevice(Convert.ToInt32(M_Profile_CB.Text)))
                    {
                        ...
                        setCobraColor();
                        Start_VisualizerBTN.Text = "Change Color";
        ...
        private void ColorBox_Click(object sender, EventArgs e)
        {
            if (ColorPicker.ShowDialog() == DialogResult.OK) {
                ...
                MousePic.BackColor = Vis_Color;
            }
        }

        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("https://github.com/indy2000");
        }
